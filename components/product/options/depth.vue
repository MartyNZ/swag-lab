  ...
  >
    ...
    <div class="flex flex-wrap gap-2">
      <div
        ...
        class="depth-selector bg-surface-300 hover:bg-surface-700 hover:text-surface-100 dark:bg-surface-700 dark:hover:bg-surface-200 dark:hover:text-surface-800 flex w-8 min-w-fit cursor-pointer items-center justify-center gap-2 rounded-lg px-2 py-1 text-sm"
