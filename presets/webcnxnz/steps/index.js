export default {
  ...
  step: ({ context, props, state }) => ({
    class: [
      ...
      // Colors
      {
        "text-surface-400 dark:text-surface-100/60":
  ...
  label: ({ context }) => ({
    class: [
      ...
      // Colors
      {
        "text-surface-400 dark:text-surface-100/60": !context.active,
        "text-surface-800 dark:text-surface-100/80": context.active,
      },
