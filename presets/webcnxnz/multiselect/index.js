export default {
  ...
  label: ({ props }) => ({
    class: [
      ...
      // Color
      {
        "text-surface-800 dark:text-surface-300": props.modelValue,
  ...
  closeButton: {
    class: [
      ...
      // States
      "hover:text-surface-700 dark:hover:text-surface300",
  ...
  item: ({ context }) => ({
    class: [
      ...
      {
        "bg-surface-200 dark:bg-surface-400 text-surface-700 dark:text-surface-300":
          context.focused && !context.selected,
      },
      {
