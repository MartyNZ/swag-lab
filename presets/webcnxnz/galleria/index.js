  ...
  galleria: {
    ...
    previousthumbnailbutton: {
      class: [
        ...
        "m-2",
        "bg-transparent text-surface-100 w-8 h-8 rounded-full transition duration-200 ease-in-out",
        "hover:bg-surface-0/10 hover:text-surface-100",
    ...
    closebutton: {
      class: [
        ...
        "m-2",
        "text-surface-100 bg-transparent w-12 h-12 rounded-full transition duration-200 ease-in-out",
        "hover:text-surface-100 hover:bg-surface-0/10",
        "focus:outline-none focus:outline-offset-0 focus:ring focus:ring-primary-400/50 dark:focus:ring-primary-300/50",
      ],
    },
    closeicon: {
    ...
    previousitembutton: ({ parent }) => ({
      class: [
        ...
        // Appearance
        "bg-transparent text-surface-100 w-16 h-16 transition duration-200 ease-in-out rounded-md",
        {
    ...
    caption: {
      class: [
        ...
        "bg-black/50 text-surface-100 p-4",
      ],
    },
    transition: {
