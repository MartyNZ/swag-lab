export default {
  ...
  column: {
    headercell: ({ context, props }) => ({
      class: [
        ...
        (props.sortable === "" || props.sortable) && context.sorted
          ...
          : "dark:text-surface-100/80 dark:bg-surface-800",
        "border-surface-200 dark:border-surface-700 ",
    ...
    sort: ({ context }) => ({
      class: [
        ...
        context.sorted ? "dark:text-primary-400" : "dark:text-surface-100/80",
      ],
    }),
    ...
    sortbadge: {
      class: [
        ...
        // Color
        "text-primary-700 dark:text-surface-100",
    ...
    filterrowitem: ({ context }) => ({
      class: [
        ...
        // Color
        { "text-surface-700 dark:text-surface-100/80": !context?.highlighted },
        {
          "bg-surface-0 dark:bg-surface-800 text-surface-700 dark:text-surface-100/80":
            !context?.highlighted,
        },
        {
    ...
    filtermenubutton: ({ context }) => ({
      class: [
        ...
        "dark:text-surface-100/70 dark:hover:text-surface-100/80 dark:bg-surface-800",
    ...
    radiobutton: ({ context }) => ({
      class: [
        ...
        // Color
        { "text-surface-700 dark:text-surface-100/80": !context.checked },
  ...
  rowexpansion: {
    class:
      "bg-surface-0 dark:bg-surface-800 text-surface-600 dark:text-surface-100/80",
  },
  rowgroupheader: {
    class: [
      "sticky z-20",
      "bg-surface-0 text-surface-600 dark:text-surface-100/70",
      "dark:bg-surface-800",
    ],
  },
  rowgroupfooter: {
