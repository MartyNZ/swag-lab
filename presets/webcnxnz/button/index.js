export default {
  root: ({ props, context, parent }) => ({
    class: [
      ...
      // Link Button
      { "text-primary-200 bg-transparent ring-transparent": props.link },

      // Plain Button
      {
        "text-surface-100 bg-surface-600 ring-1 ring-surface-500":
          props.plain && !props.outlined && !props.text,
      },
      // Plain Text Button
      { "text-surface-500 dark:text-surface-300": props.plain && props.text },
      // Plain Outlined Button
      {
        "text-surface-500 ring-1 ring-surface-500 dark:text-surface-300":
      ...
      // Outlined Button
      {
        "bg-transparent dark:text-surface-300 dark:hover:text-surface-100 dark:ring-surface-300 dark:hover:ring-surface-100":
      ...
      // Success Button
      {
        "text-surface-100 dark:text-green-900":
