export default {
  ...
  previousbutton: ({ props }) => ({
    class: [
      ...
      // Colors
      "text-surface-500 dark:text-surface-100/60",
      "border-0",
      "bg-transparent",
  ...
  weeknumber: {
    class: [
      "text-surface-600 dark:text-surface-100/70 font-normal",
      "opacity-40 cursor-default",
    ],
  },
  weekday: {
    class: [
      // Colors
      "text-surface-500 dark:text-surface-100/60 font-normal",
    ],
  },
  day: {
    class: [
  ...
  weeklabelcontainer: ({ context }) => ({
    class: [
      ...
      // Colors
      {
        "text-surface-600 dark:text-surface-100/70 bg-transparent":
